...
NEXT STEPS: 
- Modelling (K_means_clustering) as our baseline, add some plots and show metrics
- Create our own EM algorithm, add the mathematics behind it, explain why we did that. Explain our EM algorithm, show metrics and visualization, compare silhouette score or other metrics. 
- Comparison of result, which algorithm did better in what sense, compare the metrics and discuss
- What can be improve next time? What we did well?
